  ...
  <main id="main">
    ...
    <!-- <section id="resume" class="resume">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Resume</h2>
          <p>Di luar akademik, saya aktif mengikuti berbagai organisasi untuk mengembangkan diri. Partisipasi dalam organisasi-organisasi ini telah memberikan saya banyak pengalaman berharga dan keterampilan tambahan yang berguna dalam dunia profesional.</p>
        </div>
